(function (r) {
    ...
    r.fn.qrcode = function (h) {
        ...
        h = r.extend({
            ...
            render: ($.browser.msie && $.browser.version <= 8)?'table':'canvas',
            width: 256,
            height: 256,
            typeNumber: - 1,
            correctLevel: 2,
        ...
        return this.each(function () {
            ...
            if ('canvas' == h.render) {
                ...
                a.addData(h.text);
                a.make();
                d = parseInt(h.width / a.getModuleCount(), 10);
				var size = d * a.getModuleCount();
				c = r('<table></table>') .css('width', size + 'px') .css('height', size + 'px') .css('border', '0px') .css('border-collapse', 'collapse') .css('background-color', h.background);
